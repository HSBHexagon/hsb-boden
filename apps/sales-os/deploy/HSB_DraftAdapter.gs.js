...
var EXPECTED_FLYER_SHA256 = {
  JORDI: 'a11876f02b54421bcafd9a6b8ec6f62d748e383b26fcadc8bbe834ee7ffbc4ce',
  JOEL:  '6ac5ed1112c88768ac56950faab8802ceaa2817913f35a7b95e73ee79c3431d8'
};
...
function signaturHtml_(ownerDisplay, mailbox, mobile) {
  ...
  return '<p style="margin:16px 0 0 0;font-family:Arial,Helvetica,sans-serif;'
    ...
    + '<a href="https://' + FIRMA.web + '/abmelden" target="_blank" style="font-weight:bold;color:#1155cc;text-decoration:underline;"><u>Hier abmelden</u></a>'
    + '&nbsp;&middot;&nbsp;'
    + '<a href="mailto:' + htmlEscape_(mailbox) + '?subject=Abmelden" style="color:#666666;text-decoration:underline;">per E-Mail abmelden</a>'
    + '</td></tr></table>'
