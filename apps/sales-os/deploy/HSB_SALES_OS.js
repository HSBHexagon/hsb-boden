...
function ensureScriptPropsSeed_() {
  // Sicherheits-Sanierung (Zero-Token-Leakage):
  // Keine Klartext-Schlüssel, Tokens oder SAS-Signaturen im Quellcode.
  // ScriptProperties werden dynamisch über das Menü "HSB Sales OS -> 📮 Mit Outlook verbinden"
  // bzw. "🔗 Adapter-URL Joel setzen" im persistenten ScriptProperties-Speicher gepflegt.
}
