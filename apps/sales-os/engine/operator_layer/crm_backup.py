...
out = os.path.expanduser("~/KI-System/08_System/backups/20260917-hsb-crm-sheet"); os.makedirs(out, exist_ok=True)
copy = drive.files().copy(fileId=SID, body={"name":"HSB CRM MASTER 6424 – Sales OS – BACKUP-2026-09-17"}).execute()
