// Häufige Fragen für Startseite – geteilte Quelle für HomepageFAQSection und FAQPage-JSON-LD.
export const homepageFaqs = [
  ...
  {
    question: "Wie lange hält ein fachgerecht ausgeführtes Bodensystem?",
    answer:
  ...
  {
    question: "Was ist bei wassergefährdenden Stoffen (WHG) zu beachten?",
    answer:
  ...
  {
    question: "Wie lassen sich Rutschhemmung und Reinigbarkeit vereinbaren?",
    answer:
  ...
  {
    question: "Welche Böden sind auditrelevant in Lebensmittelbetrieben?",
    answer:
  ...
  {
    question: "Wie verhält sich HSB gegenüber Herstellern wie Argelith oder Zahna?",
    answer:
  ...
  {
    question: "Was muss ich für eine erste Anfrage bereithalten?",
    answer:
