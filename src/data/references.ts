...
export const references: ReferenceRecord[] = [
  ...
  },
  {
    id: "meggle-gebesee",
    publicName: "Meggle",
    anonymousName: "Molkereiproduktion in Thüringen",
    canShowLogo: true,
    canShowExactLocation: true,
    industry: "molkerei",
    city: "Gebesee",
    ...
    challenge:
      "Typische Belastung in der Milchverarbeitung durch Milchsäure, Feuchte und Reinigungsroutine.",
    solution:
      "Belastbares Bodensystem mit auf den Betrieb abgestimmter Entwässerung und Detailanschlüssen.",
    result: "Dauerhaft reinigungsfähige Fläche für den laufenden Betrieb.",
    images: [
      "/media/hsb/projekte/entwaesserungsrinne-detail.webp",
      "/media/hsb/projekte/keramik-halle-rinnen.webp",
    ],
  ...
  },
  {
    ...
    lat: 50.42,
    lng: 7.49,
    systems: ["keramische-industrieboeden", "industrieboden-saeureschutz"],
    projectType: "Sanierung",
    challenge:
      "Hygieneanforderungen und Reinigungschemie in der Lebensmittelproduktion.",
    solution:
      "Hygienisches, chemikalienbeständiges Bodensystem mit fachgerechten Detailanschlüssen.",
    result: "Auditfähige, reinigungsfähige Produktionsfläche.",
    images: [
      "/media/hsb/projekte/produktionsanlage-keramik.webp",
      "/media/hsb/projekte/verlegung-keramik.webp",
    ],
