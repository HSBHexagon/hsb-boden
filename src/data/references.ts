export const references = [
  ...
  },
  {
    id: "meggle-gebesee",
    publicName: "Meggle",
    anonymousName: "Molkereibetrieb in Thüringen",
    canShowLogo: true,
    canShowExactLocation: true,
    industry: "molkerei",
    city: "Gebesee",
    ...
    lng: 10.90,
    systems: ["keramische-industrieboeden", "entwaesserung-industrieboden"],
    projectType: "Sanierung Produktionsbereich",
    challenge: "Hohe Temperaturschwankungen und Milchsäurebelastung im Abfüllbereich.",
    solution: "Rüttelkeramik-System mit hochbeständiger Epoxidharzverfugung und integrierter Edelstahl-Entwässerung.",
    result: "Hygienisch einwandfreier, langlebiger Bodenbelag für höchste Produktionsstandards.",
    images: [
      "/media/hsb/projekte/keramik-halle-rinnen.webp",
      "/media/hsb/projekte/hexagon-rinne-detail.webp"
    ],
    logo: "/logos/meggle.svg",
    year: "2025",
    approvalStatus: "approved" as "approved" | "anonymous" | "internal",
  },
  {
    id: "biovegan-bonefeld",
    publicName: "Biovegan GmbH",
    anonymousName: "Lebensmittelproduktion in Rheinland-Pfalz",
    canShowLogo: true,
    canShowExactLocation: true,
    industry: "lebensmittelindustrie",
    city: "Bonefeld",
    ...
    lat: 50.42,
    lng: 7.49,
    systems: ["pu-beton-industrieboden", "whg-abdichtung-industrieboden"],
    projectType: "Neubau und Abdichtung",
    challenge: "Strenge Bio-Hygienerichtlinien und WHG-Anforderungen an die Bodenbeschichtung.",
    solution: "Fugenloser PU-Beton-Boden mit geprüfter WHG-Abdichtungsebene für maximale Sicherheit.",
    result: "Reinraum-taugliche Oberflächenbeschaffenheit bei gleichzeitig hoher mechanischer Belastbarkeit.",
    images: [
      "/media/hsb/projekte/produktionsanlage-keramik.webp",
      "/media/hsb/projekte/halle-doppelrinne-keramik.webp"
    ],
    logo: "/logos/biovegan.svg",
    year: "2024",
    approvalStatus: "approved" as "approved" | "anonymous" | "internal",
  },
] as const;
