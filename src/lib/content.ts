...
// ⚡ Bolt: Cache public references at module scope to prevent O(N) filtering/mapping on every call
...
// ⚡ Bolt: Cache all public pages at module scope to prevent mapping over multiple arrays/objects on every call
const allPublicPagesCache = [
  {
